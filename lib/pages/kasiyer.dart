...
class kasiyer extends StatelessWidget {
                                          ...
                                          if (response.docs.isNotEmpty) {
                                            for (var element in response
                                              ...
                                              var toplamfiyat =
                                                  element["fiyat"] *
                                                      element["adet"];
                                              fiyatlist.add(toplamfiyat ?? 0);
                                            }
                                          }
                                          for (int i = 0;
                                              i < fiyatlist.length;
                                              i++) {
                                            hesap = fiyatlist[i] + hesap;
                                          }
                                                    ...
                                                    child: ListView.builder(
                                                        itemBuilder:
                                                            (context, index) =>
                                                                AlertDialog(
                                                                  title: Text(
                                                                      "${response.docs.first.data()["urunler"][index]["urun_ad"]},${response.docs.first.data()["urunler"][index]["adet"]}adet,${response.docs.first.data()["urunler"][index]["fiyat"]}tl"),
                                                                  content:
                                                                      Text(" "),
                                                                ),
                                                        itemCount: response
